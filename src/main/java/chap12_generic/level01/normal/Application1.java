package chap12_generic.level01.normal;

import java.util.Arrays;

public class Application1 {
    public static <T> void swap(T[] array, int index1, int index2) throws IllegalAccessException {
        if(array == null) {
            throw new IllegalAccessException("배열은 null일 수 없습니다.");
        }
